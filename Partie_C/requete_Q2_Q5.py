...
# Compter le nombre de produits vendus par catégorie et par année
result = merged_df.groupby(['annee', 'nomcategorie']).size().reset_index(name="nb_produits_vendus")

# Trier par année et nombre de produits vendus
result = result.sort_values(by=['annee', 'nb_produits_vendus'], ascending=[True, False])
